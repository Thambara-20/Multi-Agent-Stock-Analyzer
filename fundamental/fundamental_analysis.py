import numpy as np
import pandas as pd
from fundamental_tools import get_fundamental_analysis
from weight import generate_weight_metrics
...
def rank_companies(ticker_list):
    ...
    return df[["Ticker", "Final_Score"]].head(5)


# Example usage
top_companies = rank_companies(
